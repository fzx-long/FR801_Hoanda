...
| CMD_ADD_NFC_KEY | 0x20 | 添加NFC钥匙（与 NFC 模块相关） |
...
| CMD_OIL_VEHICLE_FIND_STATUS | 0x32 | 油车寻车状态查询（携带 DATA：音量等） |
...
| CMD_Side_stand_switch_off | 0x96 | 侧支架关闭（头文件注释被截断） |
...
| CMD_HDC_switch_on | 0x100 | HDC 开启 |
| CMD_HDC_switch_off | 0x101 | HDC 关闭 |
| CMD_HHC_switch_on | 0x102 | HHC 开启 |
| CMD_HHC_switch_off | 0x103 | HHC 关闭 |
| CMD_Starting_strength_set | 0x104 | 起步强度设置 |
| CMD_SPORT_mode_on | 0x105 | SPORT 开启 |
| CMD_SPORT_mode_off | 0x106 | SPORT 关闭 |
| CMD_SPORT_mode_default | 0x107 | SPORT 默认 |
| CMD_SPORT_mode_type_set | 0x108 | SPORT 类型设置 |
| CMD_ECO_mode_on | 0x109 | ECO 开启 |
| CMD_ECO_mode_off | 0x110 | ECO 关闭 |
| CMD_ECO_mode_default | 0x111 | ECO 默认 |
| CMD_ECO_mode_type_set | 0x112 | ECO 类型设置 |
| CMD_Radar_switch_on | 0x113 | 雷达开启 |
| CMD_Radar_switch_off | 0x114 | 雷达关闭 |
| CMD_Radar_switch_default | 0x115 | 雷达默认 |
| CMD_Radar_sensitivity_set | 0x116 | 雷达灵敏度（00低/01中/02高） |
| CMD_Tire_pressure_monitoring_get | 0x117 | 胎压监测数据获取(Data: 轮位1B; Resp: 轮位1B+ID 4B+压力2B+温度1B+电压2B+状态1B+MAC 6B) |
