...
#define FPB_CTRL_KEY_Msk                    (1UL << FPB_CTRL_KEY_Pos)

#define FPB_CTRL_EN_Pos                     0
#define FPB_CTRL_EN_Msk                     (1UL << FPB_CTRL_EN_Pos)

#define FPB_COMP_EN_Pos                     0
#define FPB_COMP_EN_Msk                     (1UL << FPB_COMP_EN_Pos)

#define FPB_COMP_ADDR_Pos                   2
#define FPB_COMP_ADDR_Msk                   (0x7FFFFFFUL << FPB_COMP_ADDR_Pos)

#define FPB_COMP_REPLACE_Pos                30
#define FPB_COMP_REPLACE_Msk                (0x03UL << FPB_COMP_REPLACE_Pos)
...
static __INLINE void FPB_Enable(void)
{
    FPB->CTRL = FPB->CTRL | 0x03;
}

static __INLINE void FPB_SetRemap(uint32_t address)
{
    FPB->REMAP = address;
}
