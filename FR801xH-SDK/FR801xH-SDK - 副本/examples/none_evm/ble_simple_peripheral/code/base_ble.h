...
#include <stdint.h>
/*****************************Type Define**************************************/
# define CONNCT_DEIVCE_MAX_NUM  3 //最大连接设备数3 用于判断是否有空闲连接设备位置
...
typedef struct {
        ...
        BLE_Peripheral_Ops_V2_t  ops; //操作函数指针结构体 主要是对蓝牙底层驱动的操作
}BLE_Peripheral_Base_t;
/*****************************Function Declare**********************************/
/*********************************************************************
 * @brief  初始化连接设备 
 * @param  device: 指向要初始化的设备结构体指针 也就是上面的connected_devices数组
 */
